...
/**
 * Foldery galerii. Bez „Folder nadrzędny” = kategoria główna (np. Turnieje). Z „Folder nadrzędny” = podfolder/wydarzenie.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface GalleryAlbum {
  ...
  cover?: (number | null) | Media;
  /**
   * Zostaw puste → folder główny (kategoria). Wybierz folder → podfolder/wydarzenie w tej kategorii.
   */
